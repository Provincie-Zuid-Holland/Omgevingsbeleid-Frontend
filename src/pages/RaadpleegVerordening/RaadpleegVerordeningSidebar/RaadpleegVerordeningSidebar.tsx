...
interface RaadpleegVerordeningSidebarProps {
    verordening: any
}

function RaadpleegVerordeningSidebar({
    verordening,
}: RaadpleegVerordeningSidebarProps) {
...
interface RaadpleegVerordeningSidebarItemProps {
    item: any
    setNavMenuOpen: (state: boolean) => void
}

const RaadpleegVerordeningSidebarItem = ({
    item,
    setNavMenuOpen,
