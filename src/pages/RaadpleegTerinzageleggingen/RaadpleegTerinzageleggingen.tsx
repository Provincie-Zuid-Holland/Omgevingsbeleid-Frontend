...
const RaadpleegTerinzageleggingen = () => (
    <div>
        <div>
            <Container className="mb-8 overflow-hidden">
                <div className="col-span-3">
                    ...
                    <Text type="introduction-paragraph" className="mt-3">
                        Het Omgevingsbeleid van de provincie verandert geregeld.
                        Op deze pagina kun je zien welke beleidswijzigingen
                        momenteel ter inzage liggen. Op die manier wordt voor
                        iedereen duidelijk wat er verandert.
                    </Text>
                    <Button
            ...
            <Container className="py-16">
                <div className="col-span-6">
                    ...
                    <Text type="body" color="text-white" className="mt-4">
                        ...
                        kunnen aanleiding zijn om eventuele correcties of andere
                        wijzigingen door te voeren. De terinzagelegging duurt 6
                        weken.
                    </Text>
                </div>
            </Container>
        ...
        <div>
            <Container className="pt-16">
                ...
                <Text className="col-span-6 mt-4" type="body">
                    ...
                    ontwerp-versie van een stuk beleid, deze stukken herken je
