...
describe('TabRelations', () => {
    ...
    it('Should display the PopupMotivation component when motivationPopUp contains a value', () => {
        setup({ motivationPopUp: defaultProps.relations[0].UUID })
    ...
    it('Should display a default text if there are no beleidsrelaties', () => {
        setup({ relations: [] })
        const element = screen.getByText('Er zijn nog geen beleidsrelaties')
        expect(element).toBeTruthy
    })
})
