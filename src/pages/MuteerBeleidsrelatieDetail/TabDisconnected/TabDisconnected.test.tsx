...
describe('TabDisconnected', () => {
    ...
    it('Should display the PopupMotivation component when motivationPopUp contains a value', () => {
        setup({ motivationPopUp: defaultProps.disconnected[0].UUID })
    ...
    it('Should display a default text if there are no beleidsrelaties that are disconnected', () => {
        setup({ disconnected: [] })
