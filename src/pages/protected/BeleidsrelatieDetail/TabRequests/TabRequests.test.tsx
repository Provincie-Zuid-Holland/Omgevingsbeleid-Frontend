...
import TabRelations from './TabRequests'

import { MemoryRouter } from 'react-router-dom'

describe('TabRequests', () => {
        ...
        requests: [
            {
                ...
                Created_Date: '2021-05-25T14:42:56.113000Z',
                Status: 'NietAkkoord',
                Van_Beleidskeuze: {
                    ID: 740,
    ...
    it('Should display the PopupMotivation component when motivationPopUp contains a value', () => {
        setup({ motivationPopUp: defaultProps.requests[0].UUID })
    ...
    it('Should display a default text if there are no requests', () => {
        setup({ requests: [] })
        const element = screen.getByText('Er zijn nog geen verzoeken')
        expect(element).toBeTruthy
    })
})
