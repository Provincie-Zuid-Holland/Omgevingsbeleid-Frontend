...
class Hoofdstuk extends React.Component {
    render() {
                    ...
                    <div className="w-full inline-block flex-grow">
                        ...
                        >
                            <ContainerFormSection
                                ...
                                beschrijving="De algemene informatie bevat een hoofdstuknummer en een duidelijke titel"
                            >
                                <FormFieldTextInput
                                    handleChange={this.context.handleChange}
                                    fieldValue={crudObject['Volgnummer']}
                                    fieldLabel="Hoofdstuk"
                                ...
                                <FormFieldTextInput
                                    ...
                                    pValue="Beschrijf in een aantal woorden de titel van dit hoofdstuk"
                                    titelEnkelvoud={titelEnkelvoud}
                                />
                            </ContainerFormSection>
...
Hoofdstuk.contextType = APIcontext
