        ...
        return (
            <div className="bg-white rounded shadow p-4 mb-4">
                <div className="flex items-center justify-start">
                    ...
                    <h3 className="inline-block font-bold text-lg ml-4 text-gray-800">Verzoek tot overdracht eigenaarschap</h3>
                    <span className="absolute right-0 text-gray-600 font-thin mr-16 text-sm">1 dag geleden</span>
                </div>
                    ...
                    <div className="mt-4 mb-2 py-4 flex justify-start items-center">
                        <div className="rounded shadow p-2 flex justify-start items-center pr-4">
                            ...
                            <div className="flex flex-col">
                                <span className="line-through text-gray-700 text-xs block">Eigenaar 1</span>
                                <span className="font-bold text-lg text-gray-800 block">Tom van Gelder</span>
                            </div>
                        </div>
                        <FontAwesomeIcon 
                        ...
                        <div className="rounded shadow p-2 flex justify-start items-center pr-4">
                            ...
                            <div className="flex flex-col">
                                <span className="text-gray-700 text-xs block">Eigenaar 2</span>
                                <span className="font-bold text-lg text-gray-800 block">Coen van Bovenkamp</span>
                            </div>
                        </div>
                    </div>
                    <div>
                        <p className="text-sm text-gray-700 mb-4">Wil je dit eigenaarschap accepteren?</p>
