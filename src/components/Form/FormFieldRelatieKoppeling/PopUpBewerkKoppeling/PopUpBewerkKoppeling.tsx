...
interface PopUpBewerkKoppelingProps {
    ...
    verwijderKoppelingRelatie: (bewerkItem: any) => void
    wijzigKoppelingRelatie: (bewerkItem: any, description: string) => void
}
            ...
            <div className="flex items-center justify-between mt-6">
                <div>
                    ...
                    <span
                        ...
                        onClick={() => {
                            verwijderKoppelingRelatie(bewerkItem)
                            togglePopup()
                        }}>
                        Verwijderen
                    </span>
                ...
                <div
                    ...
                    onClick={() => {
                        if (description.length > 0) {
                            wijzigKoppelingRelatie(bewerkItem, description)
                            togglePopup()
                        } else {
                            return
                        }
