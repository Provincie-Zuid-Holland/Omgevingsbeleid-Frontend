	...
	render() {
		return (
			...
			<div className="container mx-auto m-4 h-full flex flex-wrap bg-white shadow-md rounded">
				<div className="w-1/2 px-8 pt-6 pb-8">
					...
					<form className="my-8" onSubmit={this.handleFormSubmit}>
						<div className="mb-4">
							...
							<input required className="shadow appearance-none border rounded w-full py-3 leading-loose px-3 text-grey-darker leading-tight focus:outline-none focus:shadow-outline" name="identifier" id="identifier" type="text" placeholder="bijv. f.vermeulen@pzh.nl" onChange={this.handleChange}/>
						</div>
						<div className="mb-4 mt-6">
							<label className="block text-grey-darker text-sm font-bold mb-2" htmlFor="password">
								Wachtwoord
							</label>
							<input required className="shadow appearance-none border rounded w-full py-4 pb-3 leading-loose px-3 text-grey-darker mb-3 leading-tight focus:outline-none focus:shadow-outline" name="password" id="password" type="password" placeholder="******************" onChange={this.handleChange}/>
						</div>
						<div className="">
					...
					<div id="error-message" className="container items-center justify-center hidden">
						<div className="bg-red-lightest w-full border border-red-light pr-10 text-red-dark px-4 py-3 rounded relative inline-block" role="alert">
				...
				<div className="w-1/2 login-afbeelding rounded rounded-l-none">
				</div>
