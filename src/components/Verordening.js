    ...
    render() {
        ...
        return (
            <div className="container mx-auto flex px-6 pb-8">
                {this.state.showMainSideBar ? null : <MainSidebar />}

                {/* Container */}

                <div
                    className={`${
                        this.state.showMainSideBar ? 'w-1/3' : 'w-full'
                ...
                >
                    ...
                    <div className="px-5 py-5 bg-white rounded shadow">
                        <div className="flex justify-between">
                            <h2 className="mb-4 text-gray-700 text-xl font-bold mb-2 inline-block">
                                Verordening
                            </h2>
                            <div className="flex">
                                <VerordeningSettingsTooltip
