    ...
    dynamicSections: [
        {
            fields: [
                ...
                },
                {
                    ...
                    description: (
                        <>
                            Om de ambitie beter vindbaar te maken door middel
                            van annotaties in de landelijke voorziening kun je
                            de ambitie voorzien van één of meerdere hoofdlijnen.
                            Indien een nieuwe hoofdlijn gewenst is, neem dan
                            contact op met{' '}
                            <a
