...
// !REFACTOR! -> Dit bestand omzetten naar constant files in .src/constants voor meer seperation en makkelijker te onderhouden (IN PROGRESS)
...
export default {
    ...
    Belangen: {
        ...
        properties: {
            ...
            Type: {
                type: 'string',
                enum: ['Nationaal Belang', 'Wettelijke Taak & Bevoegdheid'],
                UI: {
                    userCRUD: true,
    ...
    Beleidsbeslissingen: {
        ...
        variables: {
            Titel_Enkelvoud: 'Beleidskeuze',
            Titel_Meervoud: 'Beleidskeuzes',
            Api_Endpoint: 'beleidsbeslissingen',
            Overzicht_Slug: 'beleidskeuzes',
            Create_New_Slug: 'nieuwe-beleidskeuze',
    ...
    Maatregelen: {
        ...
        properties: {
            ...
            Specifiek_Of_Generiek: {
                type: 'string',
                default: null,
                enum: ['Gebiedsspecifiek', 'Generiek'],
                nullable: true,
                UI: {
                    userCRUD: true,
                    CRUDComponent: 'TextField',
    ...
    Verordeningen: {
        ...
        properties: {
            ...
            Type: {
                type: 'string',
                enum: ['Hoofdstuk', 'Afdeling', 'Paragraaf', 'Artikel'],
                UI: {
                    userCRUD: true,
                    CRUDComponent: 'Select',
                },
