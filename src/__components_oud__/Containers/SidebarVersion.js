            ...
            <div className="overflow-hidden max-w-xs w-full">
                ...
                <div className="block group p-4 border-b no-underline">
                    ...
                    <p className="text-gray-700 mb-2 group-hover:text-white">
                        {sideBarContent
                            ? format(
                                  new Date(sideBarContent.Modified_Date),
                                  'MM/DD/YYYY'
                              )
                            : 'Loading...'}
                    </p>
                ...
                <div className="block group p-4 border-b no-underline">
                    ...
                    <p className="text-gray-700 mb-2 group-hover:text-white">
                        {sideBarContent
                            ? format(
                                  new Date(sideBarContent.Created_Date),
                                  'MM/DD/YYYY'
                              )
                            : 'Loading...'}
                    </p>
    ...
    render() {
        return (
            <div className="inline-block w-1/4">
                ...
                {this.props.ambitie.length !== 0
                    ? sidebarSingle(this.props.ambitie)
                    : 'Loading...'}
            </div>
        )
    }
