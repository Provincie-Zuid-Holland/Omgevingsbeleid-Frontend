 ...
 */
const getValidStatuses = (nextStatusObject: any) => {
    const validStatuses: any[] = []

    Object.keys(nextStatusObject).forEach(key => {
        nextStatusObject[key].forEach((status: any) =>
 ...
 */
const checkForInvalidRequiredValues = (obj: any) => {
    ...
    properties.forEach(key => {
        ...
        requiredStatuses.forEach((status: any) => {
