const beleidskeuzeChangesNew = {
    ID: 718,
    UUID: '335225F1-B774-452E-A951-730211AFDF79',
    ...
    Modified_Date: '2021-08-08T09:23:13.060000Z',
    Eigenaar_1: null,
    Eigenaar_2: null,
    ...
    Opdrachtgever: null,
    Status: 'Vigerend',
    Titel: "Adequaat aanbod openbaar vervoer<div class='revision-removal'> (In Inspraak Test)</div>",
    Omschrijving_Keuze:
        "<div class='revision-removal'><p></div>De provincie realiseert, samen met de MRDH, een adequaat aanbod van Openbaar Vervoer in het vervoergebied van de provincie Zuid-Holland. Openbaar vervoer moet snel, betrouwbaar en beschikbaar zijn en is daarmee een volwaardig alternatief.<div class='revision-removal'></p><p><br></p><p></div><div class='revision-insert'>\n\n</div>Goed openbaar vervoer (OV) voldoet aan de kwaliteitscriteria snel, frequent, betrouwbaar, beschikbaar en betaalbaar. Samen met lopen, de fiets en deelsystemen maakt OV een reis van deur tot deur mogelijk. We zetten in op verbeteringen waar OV sterk is: snelle collectieve verplaatsingen tussen kernen.<div class='revision-removal'></p></div>",
    Omschrijving_Werking:
        "<div class='revision-removal'><p></div>Het bestaande mobiliteitssysteem is onvoldoende toegerust om de groei in personenmobiliteit te verwerken en zorgt regelmatig voor files en parkeerproblemen. Daarom gaan we mensen positief verleiden van modaliteiten gebruik te maken die de groei op een duurzame manier kunnen opvangen. Ook stimuleren we verschuiving van reizen van de spits- naar de daluren, zodat het systeem zo optimaal mogelijk wordt benut.<div class='revision-removal'></p><p><br></p><p></div><div class='revision-insert'>\n\n</div>Mensen moeten zoveel mogelijk keuzevrijheid hebben om de modaliteiten te kiezen die het best bij hun reis passen. De reis van deur-tot-deur staat hierbij centraal. Iedereen moet zich kunnen verplaatsen. Hiervoor wordt het mobiliteitsnetwerk compleet gemaakt en wordt overstappen tussen modaliteiten zo makkelijk mogelijk.<div class='revision-removal'></p><p><br></p><p></div><div class='revision-insert'>\n\n</div>Per locatie is maatwerk nodig om te kijken welke mix van modaliteiten het best passend is. We zetten in op het vergroten van het aandeel gezonde, duurzame en ruimtelijk efficiënte modaliteiten als lopen, fietsen en openbaar vervoer. Dit doen we door deze modaliteiten zo aantrekkelijk te maken dat het een logisch alternatief wordt voor de reiziger. Dit kan door het bestaande systeem te verbeteren door te investeren in nieuw hoogwaardig OV en snelfietsroutes, door te bouwen bij bestaand hoogwaardig OV en de openbare ruimte anders in te richten. We zetten in op betere ketenmobiliteit door overstappen tussen modaliteiten makkelijker te maken. We stimuleren – daar waar het kan – lopen, fietsen vervolgens OV-gebruik en pas daarna privaat autogebruik.<div class='revision-removal'></p></div>",
    Aanleiding:
        "<div class='revision-removal'><p></div>Door economische groei worden naar verwachting niet alleen meer reizen gemaakt door bestaande inwoners, maar er komen tot 2040 ook nog 240.000 huizen bij. We zien een verschuiving, waarbij mensen in steden minder van de auto gebruik maken en juist vaker kiezen voor actieve vervoerswijzen als lopen, fietsen en openbaar vervoer. Reispatronen van mensen worden steeds gevarieerder. Hierbij combineren reizigers steeds meer bestemmingen op een reis. Dit stelt extra eisen aan het mobiliteitssysteem, het voor- en natransport en de ruimtelijke ordening.<div class='revision-removal'></p></div>",
    Afweging: '',
    Provinciaal_Belang:
        "<div class='revision-removal'><p></div>Op grond van de Wet Personenvervoer 2000 is de provincie Zuid-Holland opdrachtgever voor het openbaar vervoer in de regio’s Holland Rijnland, Midden-Holland, Drechtsteden en Alblasserwaard, en de gemeenten Hoeksche Waard en Goeree Overflakkee.<div class='revision-removal'></p></div>",
    Weblink: 'http://idms/otcs/llisapi.dll/open/PZH-2021-771175798',
    Besluitnummer: 'PZH-2021-771175798',
    Tags: '',
    Aanpassing_Op: null,
    Latest_Version: 'C8C25F75-8A05-41C5-B986-BA6F70025A26',
    Latest_Status: 'Definitief ontwerp GS concept',
    Effective_Version: '68CFDBC1-249D-47B7-8EC4-2BEB1E358324',
    Belangen: { new: [], removed: [], same: [] },
    Beleidsdoelen: { new: [], removed: [], same: [] },
    Beleidsprestaties: {
        new: [],
        removed: [],
        same: [
            {
                ...
                Object: {
                    ID: 843,
                    UUID: 'E5C63B22-7B4A-4589-8EFE-77E047FD02DE',
                    Begin_Geldigheid: '2020-11-11T00:00:00Z',
                    Eind_Geldigheid: '2099-12-31T00:00:00Z',
                    Created_By: '00000000-0000-0000-0000-000000000000',
                    Created_Date: '2020-10-21T13:22:00Z',
                    Modified_By: '9D4F11BE-A502-4DCE-A6FA-24FB827FD6B7',
                    Modified_Date: '2021-03-08T08:04:02.310000Z',
                    Titel: '2-1-2 Passend en efficiënt personenvervoer',
                    Omschrijving:
                    ...
                    Weblink:
                        'http://idms/otcs/llisapi.dll/properties/PZH-2020-747840424',
                },
            },
        ],
    },
    Beleidsregels: { new: [], removed: [], same: [] },
    Maatregelen: { new: [], removed: [], same: [] },
    Themas: { new: [], removed: [], same: [] },
    Verordeningen: { new: [], removed: [], same: [] },
    Werkingsgebieden: {
        new: [
            {
                Koppeling_Omschrijving: 'Productie Export 2021-09-01',
                Object: {
                    ID: 13,
                    UUID: 'FB5AC666-52EC-4811-9BB8-8841522174FF',
                    Begin_Geldigheid: '2021-08-07T00:00:00Z',
                    Eind_Geldigheid: '2099-12-31T23:23:59Z',
                    Created_By: '00000000-0000-0000-0000-000000000000',
    ...
    Beleidskeuzes: {
        new: [
            {
                Koppeling_Omschrijving: 'Dit is een test',
                Object: {
                    ID: 742,
                    UUID: 'FF3172F6-8689-449D-A6AF-2EB53F6893B1',
                    Titel: 'Beleven en benutten van erfgoed',
                },
            },
            {
                Koppeling_Omschrijving: 'Dit is een test',
    ...
    Ref_Beleidsmodules: {
        ...
        removed: [
            {
                ID: 6,
                UUID: '8B22C0BC-6FDF-4BF3-976B-E096D29888E3',
                Titel: 'Beleidsmodule van Aiden',
            },
        ],
        same: [],
    },
...
export default beleidskeuzeChangesNew
