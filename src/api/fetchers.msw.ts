...
export const getAmbitiesValidGetResponseMock = (
    ...
    results: Array.from(
        ...
        Adjust_On: faker.helpers.arrayElement([
            faker.helpers.arrayElement([faker.string.uuid(), {}]),
            undefined,
        ]),
...
export const getAmbitiesVersionObjectUuidGetResponseMock = (
    ...
    Created_By: faker.helpers.arrayElement([
        faker.helpers.arrayElement([
            { UUID: faker.string.uuid(), ...overrideResponse },
            {},
        ]),
        undefined,
    ]),
...
export const getModulesModuleIdObjectOnderverdelingLatestLineageIdGetResponseMock =
    (overrideResponse: any = {}): OnderverdelingFull => ({
        Adjust_On: faker.helpers.arrayElement([
            faker.helpers.arrayElement([faker.string.uuid(), {}]),
            undefined,
        ]),
...
export const getPublicationAnnouncementPackagesAnnouncementPackageUuidReportPostResponseMock =
    (overrideResponse: any = {}): UploadPackageReportResponse => ({
        Duplicate_Count: faker.number.int({ min: undefined, max: undefined }),
        Status: faker.helpers.arrayElement(Object.values(ReportStatusType)),
        ...overrideResponse,
    })
...
export const getOnderverdelingenValidGetMockHandler = (
    overrideResponse?: PagedResponseOnderverdelingBasic
) => {
    return http.get('*/onderverdelingen/valid', async () => {
        await delay(1000)
        return new HttpResponse(
            JSON.stringify(
                overrideResponse
...
export const getOnderverdelingenValidLineageIdGetMockHandler = (
    ...
    return http.get('*/onderverdelingen/valid/:lineageId', async () => {
        await delay(1000)
        return new HttpResponse(
            JSON.stringify(
                overrideResponse
...
export const getOnderverdelingenVersionObjectUuidGetMockHandler = (
    overrideResponse?: OnderverdelingFull
) => {
    return http.get('*/onderverdelingen/version/:objectUuid', async () => {
        await delay(1000)
        return new HttpResponse(
            JSON.stringify(
                overrideResponse
...
export const getOnderverdelingenLatestLineageIdGetMockHandler = (
    ...
    return http.get('*/onderverdelingen/latest/:lineageId', async () => {
        await delay(1000)
        return new HttpResponse(
            JSON.stringify(
                overrideResponse
...
export const getOnderverdelingStaticLineageIdPostMockHandler = (
    ...
    return http.post('*/onderverdeling/static/:lineageId', async () => {
        await delay(1000)
        return new HttpResponse(
            JSON.stringify(
                overrideResponse
...
export const getModulesModuleIdObjectOnderverdelingLineageIdGetMockHandler = (
    overrideResponse?: PagedResponseOnderverdelingExtended
) => {
    return http.get(
...
export const getSearchByAreasPostMockHandler = (
    ...
    return http.post('*/search/by-areas', async () => {
        await delay(1000)
        return new HttpResponse(
            JSON.stringify(
                overrideResponse
...
export const getSearchByGeometryPostMockHandler = (
    ...
    return http.post('*/search/by-geometry', async () => {
        await delay(1000)
        return new HttpResponse(
            JSON.stringify(
                overrideResponse
...
export const getPublicationActPackagesActPackageUuidReportPostMockHandler = (
    overrideResponse?: UploadPackageReportResponse
) => {
    return http.post(
...
export const getPublicationDsoValueListsAreaDesignationTypesGetMockHandler = (
    overrideResponse?: AreaDesignationValueList
) => {
    return http.get(
